...
1. Enter `conda create -n data-science jupyter scikit-learn seaborn statsmodel django` to create the  data-science Conda environment and install the packages listed in it. Anaconda will add buttons to your Windows start buttons for `data-science`.
