...
1. Enter `conda create --yes --name data-science django jupyter seaborn statsmodels scikit-learn gdal psycopg2` to create the  data-science Conda environment and install the packages listed in it. Anaconda will add buttons to your Windows start buttons for `data-science`.
